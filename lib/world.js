...
export const createScene = () => {
  ...
  songNotes.forEach((songNote, idx) => {
    ...
    console.log((((songNote.m - 1) * beatsPerMeasure) + songNote.t - 1));
    let time = 237.5 * (((songNote.m - 1) * beatsPerMeasure) + songNote.t);
    // let time = 20 * vel * (yStartPoint - note.yVel * ((songNote.m - 1) * beatsPerMeasure + songNote.t - 1) * noteInterval );
    // console.log("vel:", note.yVel);
